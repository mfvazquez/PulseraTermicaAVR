...
La piel humana necesita una diferencia de temperatura 
mayor a $0.1\, \unit{^oC}$ en una determinada zona para que
todo el cuerpo sienta esta diferencia de temperatura. 
...
durante $5\, \unit{segundos}$ y durante los siguientes $10\, \unit{segundos}$ entrará
