...
\lstdefinelanguage
   ...
   % with these extra keywords:
	...
	morecomment=[l]{*},
    	morestring=[b]',
	morekeywords={WTO,SUBENTRY,BASES,WTOR,ECB,BE,CLI,B,SUBEXIT,
	ICM,SRL,SLL,LA,BCT,MVC,CVD,UNPK,MVZ,BAL,STCM,ZAP,PACK,CVB,CLR,
	LH,H,X,MF,C,E,MVI,SR,F,AR,CLM,BNL,CLM,DC,XL400,XL1,CL1,HL2,XL1,CL4,D,CL2,PL2,BNE,IC,SRDL}
  	} % etc.
